...
import {
  LayoutDashboard, Plus, FileText, BarChart3, Settings,
  Shield, Users, LogOut,
} from "lucide-react";
...
const items = [
  ...
  { to: "/dashboard/nueva-boleta", label: "Nueva Boleta",    icon: Plus            },
...
export default function Sidebar() {
  return (
    <aside className="w-60 shrink-0 h-full bg-white border-r flex flex-col">
      {/* logo */}
      <div className="flex items-center gap-2 px-6 py-5">
        ...
        <div>
          <p className="text-lg font-bold leading-none">Gestor</p>
